...
import { BookMarked, Sparkles, FolderSymlink, ArrowRight, HardDrive, CheckCircle2 } from "lucide-react";
...
export function LoginPage() {
  ...
  const handleConnect = (e: React.FormEvent) => {
    ...
    toast.success("Google Drive link connected! Opening archive...");

    // Auto connect directly into the CMS without forced login!
    setTimeout(() => {
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Paste any Google Drive folder link to instantly connect and manage files.
          </p>
        </div>

        {/* Drive Link Direct Auto-Connect Form */}
        <form onSubmit={handleConnect} className="space-y-4 text-left pt-2">
          <div className="space-y-2">
            ...
            <p className="text-[11px] text-muted-foreground flex items-center gap-1">
              ...
              <span>Instant auto-connect without requiring login</span>
            </p>
          </div>
